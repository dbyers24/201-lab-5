...
function sumAndMultiply(a, b, c){ //eslint-disable-line
  ...
  return [theSum, product, message, message2];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var message = testArray.join(',') + ' was passed in as an array of numbers, and ' + theSum + ' is their sum.';
  console.log(message);
  return [theSum, message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  console.log(product);
  var message = 'The numbers ' + testArray.join(',') + ' have a product of ' + product + '.';
  console.log(message);
  return [product, message];
}
